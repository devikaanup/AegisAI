...
## Data Sourcing Statement & Limitations

- **Data Sourcing**: Demo dataset features a seeded, fictionalized street grid representing "Riverside Heights", anchored near Katpadi, Vellore (`[79.1520, 12.9680]`). All coordinates, elevations, and road attributes are deterministically generated by `/scripts/generate-data.ts`.
...
- **Limitations**:
  - **Hazard Type**: Flood only (flash riverine overflow spreading northward from row 0).
...
- **Showcase**: Point to the **Compare Card**:
  - Standard GPS directs Marcus along **Riverside Rd / Temple Steps**: `240m · 0 min walk — ✕ Steps on Temple Steps`.
...
- **Showcase**:
  - Blue floodwaters advance across row 0 and Market St.
  ...
  - Ask **"What changed?"**: System confirms Market St flooded at minute 10.
